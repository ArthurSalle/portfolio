      ...
      <footer className="footer" id="contact">
        ...
        <div className="footer--link">
          <div className="footer--contact">
            ...
            <a target="blank" href="https://www.linkedin.com/in/arthur-sall%C3%A9/">
          ...
          <div className="footer--stack">
            <Paragraph className="h4">Made with</Paragraph>
            <Paragraph className="drop--color">
              React, Gatsby, Sass et AnimeJs, font TT Norms by Ivan Gladkikh, photos by Unsplash, design réalisé avec
              Armand & Pierre Louis{" "}
            ...
            <div className="footer--copyright">
              <Paragraph className="drop--color drop--copyright">All Rights Reserved.</Paragraph>
              <Paragraph className="drop--color drop--copyright">Arthur Sallé 2021 ©</Paragraph>
            </div>
          </div>
        </div>
      </footer>
