      ...
      <div className="project">
        <div className="project--row">
          <div className="project--content">
            ...
            <Paragraph>
              Coffre-fort permettant le stockage de vos identifiants de connexion, cartes de crédit et informations
              d'identité. L'application inclut également un générateur de mots de passe pour renforcer la sécurité de
      ...
      <div className="project">
        <div className="project--row">
          <div className="project--content">
            ...
            <Paragraph>
              Développement d'un outil interne pour la DSI Onepoint, favorisant la collaboration, la gestion des
              collaborateurs, des ressources matérielles, et la diffusion d'informations au sein de l'organisation.
            </Paragraph>
          </div>
          <div>
            <div className="project--link">
      ...
      <div className="project">
        <div className="project--row">
          <div className="project--content">
            ...
            <Paragraph>Site de recettes familiales réalisé en collaboration avec Armand Sallé.</Paragraph>
          </div>
          <div>
            <div className="project--link">
              <a
      ...
      <div className="project">
        <div className="project--row">
          <div className="project--content">
            ...
            <Paragraph>
              Stage de fin de formation. Création d'une interface de traduction avec i18n et création de la partie Blog
              du site.
            </Paragraph>
          </div>
          <div>
